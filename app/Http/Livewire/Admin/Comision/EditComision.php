...
{
    public $comision, $disabled, $agentesSelected, $choferSelected, $provinciaSelected, $localidadesSelected;
    ...
    public function mount(Comision $comision) {
        ...
        $this->agentesSelected = $this->comision->agentes->pluck('nombre','id')->toArray();
